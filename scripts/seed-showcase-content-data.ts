...
export const CONTENT: ScaleContent[] = [
  ...
  {
    project: { slug: "ward_compost_network", title: "Ward Compost Network", summary: "Neighbourhood composting that diverted 4.2 tonnes of kitchen waste per ward per year.", body: "A drop-point, a weekly meet-up and a shared bin turn waste into soil and neighbours into a community.", highlights: ["38 wards", "4.2 tonnes per ward per year", "Soil sold back to gardeners", "Two-year outcomes published"], skills: ["Community Building", "Facilitation"], links: [["Playbook", "https://kit.0dot.example/ward-compost"], ["Outcome study", "https://data.0dot.example/ward-compost"]] },
  ...
  {
    project: { slug: "planet_health_index", title: "Planetary Health Index", summary: "Open indicators that connect local measurements to planetary health, from soil to oceans.", body: "A transparent index built from community, city and national datasets, designed so local work can be seen in the global picture.", highlights: ["31 indicators", "Built from 5 open datasets", "Used in 3 university courses", "2,210 stars, 190 contributors"], skills: ["Systems Thinking", "Climate Modelling", "Open Data"], links: [["Index", "https://index.0dot.example"], ["Repository", "https://github.example/0dot/planet-health-index"]] },
...
export const EXTRA_ARTICLES: { title: string; subtitle: string; format: "article" | "tutorial" | "note"; tags: string[]; intro: string; points: string[]; closing: string }[] = [
  ...
  { title: "Field Notes: Ten Things We've Measured This Year", subtitle: "Numbers from soil to sky.", format: "note", tags: ["data", "fieldnotes", "measurement"], intro: "A running list of measurements that changed our minds.", points: ["A backyard bin: 1.8 kg of kitchen waste per household per week", "A rooftop sensor: 40% higher PM2.5 at 7am than at 2pm", "A balcony garden: 22 litres of greywater reused a week", "A seed library: 60 packets borrowed in the first month", "A class of 8-year-olds: 62 litres of avoidable waste before lunch"], closing: "Measure it and it becomes discussable." },
  { title: "Why Systems Thinking Is a Practice, Not a Diagram", subtitle: "The habit of asking 'and then what?'", format: "article", tags: ["systemsthinking", "practice"], intro: "The best systems thinkers we know are curious and humble, and their diagrams are usually messy.", points: ["Ask 'and then what happens?' once more than is comfortable", "Look one scale up and one scale down", "Prefer small experiments to grand models"], closing: "The practice is the point." },
